...
exports.handler = async event => {
  ...
  try {
    ...
    validateCreateAuthorSchema(author);
    author.id = generateUUIDv4();
    ...
    console.info(`Saving item to database. Item=${JSON.stringify(author)}, Table=${process.env.DYNAMODB_TABLE_NAME}.`);
